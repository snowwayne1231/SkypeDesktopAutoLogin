...
libsignal.SignalProtocolLib = {
    initialize: function(curveModule) {
        'use strict';
        ...
        var libCurve = curveModule;
        Internal.Curve       = wrapCurve25519(libCurve.curve);
        Internal.Curve.async = wrapCurve25519(libCurve.curve_async);
...
(function() {
    ...
    if (!crypto || !crypto.subtle || typeof crypto.getRandomValues !== 'function') {
        crypto = require('../../vendor/js/msrCrypto');
        if (!crypto) {
